...
public class Ventana extends JFrame {
	...
	// Eje Y
		...
		vectorTraslacion[0] = 0;
		vectorTraslacion[1] = -10;
		vectorTraslacion[2] = 0;
		dimension = 3;
		
		puntoTransformadoA = operaciones.trasladar(puntoInicialA, vectorTraslacion, dimension);
		puntoTransformadoB = operaciones.trasladar(puntoInicialB, vectorTraslacion, dimension);
		puntoTransformadoC = operaciones.trasladar(puntoInicialC, vectorTraslacion, dimension);
		puntoTransformadoD = operaciones.trasladar(puntoInicialD, vectorTraslacion, dimension);
		puntoTransformadoE = operaciones.trasladar(puntoInicialE, vectorTraslacion, dimension);
		puntoTransformadoF = operaciones.trasladar(puntoInicialF, vectorTraslacion, dimension);
		puntoTransformadoG = operaciones.trasladar(puntoInicialG, vectorTraslacion, dimension);
		puntoTransformadoH = operaciones.trasladar(puntoInicialH, vectorTraslacion, dimension);
		...
		// Eje Z
				...
				vectorTraslacion[0] = 0;
				vectorTraslacion[1] = 0;
				vectorTraslacion[2] = -10;
				dimension = 3;
