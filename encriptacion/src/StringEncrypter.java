...
public class StringEncrypter {
    ...
    public static void testUsingSecretKey() {
        try {
            ...
            Polybius p = new PolybiusImpl();
            String secretString = "Attack at dawn";
            String cadena = p.toPolybius(secretString);
          ...
          //  StringEncrypter desedeEncrypter = new StringEncrypter(desedeKey, desedeKey.getAlgorithm());
            ...
            // Encrypt the string
            String desEncrypted       = desEncrypter.encrypt(cadena);
          ...
          // Desencriptar Polybius
            String desencriptado = p.desPolybius(desDecrypted);
            // Print out values
            System.out.println(desKey.getAlgorithm() + " Encryption algorithm");
            System.out.println("    Original String  : " + secretString);
            System.out.println("    Polybius Encrypted String : " + cadena);
            System.out.println("    DES Encrypted String : " + desEncrypted);
            System.out.println("    DES Decrypted String : " + desDecrypted);
            System.out.println("    Polybius Decrypted String : " + desencriptado);
            System.out.println();
/*
...
*/
    ...
    public static void testUsingPassPhrase() {
        ...
        String secretString = "Universidad La Salle Oaxaca";
        String cadena = p.toPolybius(secretString);
        String passPhrase   = "Giovanni";
